                ...
                Role.
                    ...
                    populate({
                        ...
                        if (typeof(req.acl) !== "undefined" &&
                            ...
                            return next(Osf.error.msg("The user does not have access to this page.","401"));
                            //return next(Osf.error.msg("The user does not have access to this page. URL:"+req.url+" Route:"+route.join(".")+" ACL:"+JSON.stringify(req.acl),"401"));
                        }
                    });
            } else {
