...
module.exports.App = exports.App = new function () {
    ...
    this.models = function () {
        ...
        folder = path.join(this.express.get("path").root, "models");
    ...
    this.public = function () {
        ...
        this.express.use(Osf.StaticFile(this.express.get("path").public, { maxAge: 86400000, "nocache": this.express.get("nocache")}));
